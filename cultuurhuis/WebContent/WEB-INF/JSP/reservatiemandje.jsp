...
<body>
	<h1>
		Het Cultuurhuis: reservatiemandje <img alt="mandje.png"
			src="${contextPath}/images/mandje.png" />
	</h1>
	<vdab:menu />
			...
			<tbody>
				<c:forEach items="${reservatieMandjeVolledig.reserveringen}"
					...
					<tr>
						...
						<td><input type="checkbox" name="verwijderenCheckbox"
							value="${reservering.voorstelling.nummer }"></td>
					</tr>
				</c:forEach>
			</tbody>
