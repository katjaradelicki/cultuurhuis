...
<h2>${sessionScope.genre} voorstellingen</h2>
	<table class="zebra">
		...
		<tbody>
			<c:forEach items="${voorstellingen}" var="voorstelling">
				<tr class="rijenTabel">
					<td><fmt:formatDate value="${voorstelling.datum}" type="both" dateStyle="short" timeStyle="short" pattern="dd/MM/yyyy HH:mm"/> </td>
