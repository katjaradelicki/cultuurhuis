...
public class VoorstellingenServlet extends HttpServlet {
	...
	private static final Set<Genre> genres=genreDAO.findAll();//wordt één keer opgehaald uit databank bij initialisatie van deze servlet. Initialisatie van de servlet gebeurt 1 keer bij opstarten van de applicatie of bij eerste request (afhankelijk van webserver).
